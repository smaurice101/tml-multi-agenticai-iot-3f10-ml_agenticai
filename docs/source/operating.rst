...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42365, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42965, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40523, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41555, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41809, HPDEHOST=127.0.1.1, HPDEPORT=36699, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42361

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1251-tml-multi-agenticai-iot-3f10-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-preprocess-4425-tml-multi-agenticai-iot-3f10-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-ml-9550-tml-multi-agenticai-iot-3f10-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-predict-8238-tml-multi-agenticai-iot-3f10-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-agenticai-7917-tml-multi-agenticai-iot-3f10-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
